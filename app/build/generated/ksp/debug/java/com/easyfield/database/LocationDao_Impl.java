...
public final class LocationDao_Impl implements LocationDao {
  ...
  private final EntityInsertionAdapter<LocationRequest> __insertionAdapterOfLocationRequest;
  ...
  public LocationDao_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfLocationRequest = new EntityInsertionAdapter<LocationRequest>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `location` (`location_id`,`user_id`,`latitude`,`longitude`,`employee_punch_id`,`gps_status`,`battery`,`network`,`timestamp`) VALUES (?,?,?,?,?,?,?,?,?)";
      }

      @Override
      protected void bind(@NonNull final SupportSQLiteStatement statement,
          @NonNull final LocationRequest entity) {
  ...
  @Override
  public Object addLocation(final LocationRequest location,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfLocationRequest.insert(location);
  ...
  public List<LocationRequest> getAllLocations() {
    ...
    try {
      ...
      final List<LocationRequest> _result = new ArrayList<LocationRequest>(_cursor.getCount());
      while (_cursor.moveToNext()) {
        final LocationRequest _item;
        ...
        _item = new LocationRequest(_tmpLocationId,_tmpUserId,_tmpLatitude,_tmpLongitude,_tmpAttendanceId,_tmpGpsStatus,_tmpBatteryInPercentage,_tmpNetworkType,_tmpTimestamp);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  public Object deleteLocations(final Long[] ids, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        _stringBuilder.append("DELETE FROM location WHERE location_id IN (");
