...
@Entity(tableName = "location_dummy")
...
data class SaveLocationRequest(
    ...
    companion object CREATOR : Parcelable.Creator<SaveLocationRequest> {
        override fun createFromParcel(parcel: Parcel): SaveLocationRequest {
            return SaveLocationRequest(parcel)
        }

        override fun newArray(size: Int): Array<SaveLocationRequest?> {
